...
//  NoteApp
//
// Allow editing category inline when a note is in editing mode
    ...
    private var dragGesture: some Gesture {
        DragGesture()
            .onChanged { v in
                ...
                let newY = clamp(dragOrigin.y + v.translation.height, min: safeTop + spacing, max: parentSize.height - note.size.height - spacing)
